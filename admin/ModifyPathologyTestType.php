...
if($doaction=="add"){
	$pageHeading="Add Test Type";
	$submitValue="Submit";
	}
elseif($doaction=="edit"){
	
	$id=$_GET['id'];
	$pageHeading="Modify Test Type";
	$submitValue="Update";
	
	$pathologyTestTypeObj=new PathologyTestType;
	$formData=$pathologyTestTypeObj->getPathologyTestType($globalUtil,"WHERE id='".$id."'");
			...
			<table width="100%" cellpadding="0" cellspacing="0" id="InnerTable" class="InnerTable">
				<tr>
					...
					<td id="rightpanel" class="rightpanel">
						<form id="adminformmain" name="adminformmain" action="<?php echo $globalUtil->generateUrl(ADMIN_SITE_URL.CONTROLLER_FOLDER.CONTROLLER_PathologyTestType);?>" enctype="multipart/form-data" method="post" class="formstyle1">
                        <?php
                        if($doaction=="edit"){
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <?php
							if($msgInfo->hasMsg('modifyPathologyTestTypemsg')){
							?>
                    		<tr>
                    			<td class="msgposition" colspan="3"><?php echo $msgInfo->displayMsg('modifyPathologyTestTypemsg');?></td>
                    		</tr>
                            <tr>
                           	<td colspan="3" height="5px">                            </tr>
                   		    <?php
							...
							?>
                            <tr>
								<td class="formlabel">Test Type Name</td>
                                <td class="separter">:</td>
                                <td class="forminput"><div class="forminputboxbg"><input type="input" class="formtextbox" id="test_type" name="test_type" validate="{required:true,messages:{required:'Please enter a Test Type name.'}}" value="<?php echo $adminUtil->getPostFormData("test_type");?>"/></div></td>
							</tr>
                            <tr>
                           	<td colspan="3" height="5px">                            </tr>      
                            <tr>
