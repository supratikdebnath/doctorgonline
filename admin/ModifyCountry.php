...
$adminUtil->CheckAdminPagePrivs($globalUtil,$_SESSION['adminUserSession']['uid'],$_SESSION['adminUserSession']['privs'],"Modify Country");
...
if($doaction=="add"){
	$pageHeading="Add Country";
	$submitValue="Submit";
	}
elseif($doaction=="edit"){
	
	$id=$_GET['id'];
	$pageHeading="Modify Country";
	$submitValue="Update";
	
	$countryObj=new Country;
	$formData=$countryObj->getCountries($globalUtil,"WHERE id='".$id."'");
			...
			<table width="100%" cellpadding="0" cellspacing="0" id="InnerTable" class="InnerTable">
				<tr>
					...
					<td id="rightpanel" class="rightpanel">
						<form id="adminformmain" name="adminformmain" action="<?php echo $globalUtil->generateUrl(ADMIN_SITE_URL.CONTROLLER_FOLDER.CONTROLLER_Country);?>" enctype="multipart/form-data" method="post" class="formstyle1">
                        <?php
                        if($doaction=="edit"){
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <?php
							if($msgInfo->hasMsg('modifycountrymsg')){
							?>
                    		<tr>
                    			<td class="msgposition" colspan="3"><?php echo $msgInfo->displayMsg('modifycountrymsg');?></td>
                    		</tr>
                            <tr>
                            	<td colspan="3" height="5px">
                            </tr>
							...
							?>
                            <tr>
								<td class="formlabel">Country Name</td>
                                <td class="separter">:</td>
                                <td class="forminput"><div class="forminputboxbg"><input type="input" class="formtextbox" id="countryName" name="countryName" validate="{required:true,messages:{required:'Please enter a country name.'}}" value="<?php echo $adminUtil->getPostFormData("countryName");?>"/></div></td>
							</tr>
                            <tr>
                            	<td colspan="3" height="5px">
                            </tr>  
                            <tr>
                                ...
                                <td class="separter">:</td>
                                <td class="forminput"><div class="forminputboxbg"><input type="input" class="formtextbox" id="countryCode" name="countryCode" validate="{required:true,messages:{required:'Please enter country code.'}}" value="<?php echo $adminUtil->getPostFormData("countryCode");?>"/></div></td>
							</tr>      
                            <tr>
                            	<td colspan="3" height="5px">
                            </tr>                    
