...
if($doaction=="add"){
	$pageHeading="Add Insurance Company";
	$submitValue="Submit";
	}
elseif($doaction=="edit"){
	
	$id=$_GET['id'];
	$pageHeading="Modify Insurance Company";
	$submitValue="Update";
	
	$insuranceCompanyObj=new InsuranceCompany;
	$formData=$insuranceCompanyObj->getInsuranceCompany($globalUtil,"WHERE id='".$id."'");
			...
			<table width="100%" cellpadding="0" cellspacing="0" id="InnerTable" class="InnerTable">
				<tr>
					...
					<td id="rightpanel" class="rightpanel">
						<form id="adminformmain" name="adminformmain" action="<?php echo $globalUtil->generateUrl(ADMIN_SITE_URL.CONTROLLER_FOLDER.CONTROLLER_InsuranceCompany);?>" enctype="multipart/form-data" method="post" class="formstyle1">
                        <?php
                        if($doaction=="edit"){
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <?php
							if($msgInfo->hasMsg('modifyInsuranceCompanymsg')){
							?>
                    		<tr>
                    			<td class="msgposition" colspan="3"><?php echo $msgInfo->displayMsg('modifyInsuranceCompanymsg');?></td>
                    		</tr>
                            <tr>
                           	<td colspan="3" height="5px">                            </tr>
                   		    <?php
                            ...
                            <tr>
                                ...
                                <td class="forminput"><div class="forminputboxbg"><input type="input" class="formtextbox" id="insurance_company" name="insurance_company" validate="{required:true,messages:{required:'Please enter a Insurance Company.'}}" value="<?php echo $adminUtil->getPostFormData("insurance_company");?>"/></div></td>
							</tr>
                            <tr>
                           	<td colspan="3" height="5px">                            </tr>      
                            <tr>
