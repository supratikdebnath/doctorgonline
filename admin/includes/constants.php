...
define("SUCCESS_MSG_NEW_PATHOLOGY","Pathology Center added successfully.");
define("ERROR_MSG_NEW_PATHOLOGY","Unable to add Pathology Center. Try again.");
define("SUCCESS_MSG_UPDATE_PATHOLOGY","Pathology Center updated successfully.");
define("ERROR_MSG_UPDATE_PATHOLOGY","Unable to add Pathology Center. Try again.");
define("SUCCESS_MSG_PATHOLOGY_DELETE","Pathology Center deleted successfully.");
define("ERROR_MSG_PATHOLOGY_DELETE","Unable to delete state. Check status if inactive.");
define("ERROR_MSG_PATHOLOGY_EXISTS","Pathology Center doesn't exists.");

define("SUCCESS_MSG_NEW_PATHOLOGY_TEST_TYPE","Pathology Test Type added successfully.");
define("ERROR_MSG_NEW_PATHOLOGY_TEST_TYPE","Unable to add Pathology Test Type. Try again.");
define("SUCCESS_MSG_UPDATE_PATHOLOGY_TEST_TYPE","Pathology Test Type updated successfully.");
define("ERROR_MSG_UPDATE_PATHOLOGY_TEST_TYPE","Unable to update Pathology Test Type. Try again.");
define("SUCCESS_MSG_PATHOLOGY_TEST_TYPE_DELETE","Pathology Test Type deleted successfully.");
define("ERROR_MSG_PATHOLOGY_TEST_TYPE_DELETE","Unable to delete Pathology Test Type. Check status if inactive.");
define("ERROR_MSG_PATHOLOGY_TEST_TYPE_EXISTS","Pathology Test Type doesn't exists.");

define("SUCCESS_MSG_NEW_PATHOLOGY_TEST_NAME","Pathology Test Name added successfully.");
define("ERROR_MSG_NEW_PATHOLOGY_TEST_NAME","Unable to add Pathology Test Name. Try again.");
define("SUCCESS_MSG_UPDATE_PATHOLOGY_TEST_NAME","Pathology Test Name updated successfully.");
define("ERROR_MSG_UPDATE_PATHOLOGY_TEST_NAME","Unable to update Pathology Test Name. Try again.");
define("SUCCESS_MSG_PATHOLOGY_TEST_NAME_DELETE","Pathology Test Name deleted successfully.");
define("ERROR_MSG_PATHOLOGY_TEST_NAME_DELETE","Unable to delete Pathology Test Name. Check status if inactive.");
define("ERROR_MSG_PATHOLOGY_TEST_NAME_EXISTS","Pathology Test Name doesn't exists.");


define("SUCCESS_MSG_NEW_INSURANCE_COMPANY","Insurance Company  added successfully.");
define("ERROR_MSG_NEW_INSURANCE_COMPANY","Unable to add Insurance Company. Try again.");
define("SUCCESS_MSG_UPDATE_INSURANCE_COMPANY","Insurance Company updated successfully.");
define("ERROR_MSG_UPDATE_INSURANCE_COMPANY","Unable to update Insurance Company. Try again.");
define("SUCCESS_MSG_INSURANCE_COMPANY_DELETE","Insurance Company deleted successfully.");
define("ERROR_MSG_INSURANCE_COMPANY_DELETE","Unable to delete Insurance Company. Check status if inactive.");
define("ERROR_MSG_INSURANCE_COMPANY_EXISTS","Insurance Company doesn't exists.");

define("SUCCESS_MSG_NEW_INSURANCE_TPA","Insurance TPA  added successfully.");
define("ERROR_MSG_NEW_INSURANCE_TPA","Unable to add Insurance TPA. Try again.");
define("SUCCESS_MSG_UPDATE_INSURANCE_TPA","Insurance TPA updated successfully.");
define("ERROR_MSG_UPDATE_INSURANCE_TPA","Unable to update Insurance TPA. Try again.");
define("SUCCESS_MSG_INSURANCE_TPA_DELETE","Insurance TPA deleted successfully.");
define("ERROR_MSG_INSURANCE_TPA_DELETE","Unable to delete Insurance TPA. Check status if inactive.");
define("ERROR_MSG_INSURANCE_TPA_EXISTS","Insurance TPA doesn't exists.");
?>